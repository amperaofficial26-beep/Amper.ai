...
<script>
  ...
  },
  {
   ...
   },
   {
    ...
    {
      "keywords": ["berita dunia"],
      "replies": [
        "Ringkasan isu global mencakup perkembangan kecerdasan buatan, transisi energi hijau global, fluktuasi pasar saham internasional, inovasi fusi nuklir, percepatan riset bioteknologi medis, pembangunan smart city, digitalisasi mata uang CBDC, eksplorasi ruang angkasa komersial, mitigasi krisis iklim PBB, hingga kemajuan teknologi semikonduktor dunia."
      ]
    }},
    {
      "keywords": ["cinta"],
