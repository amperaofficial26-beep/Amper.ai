...
*/
  ...
  const knowledgeBase = [
    ...
    },
    {
      ...
      replies: [
        "Sama-sama! 🌸 Yuki senang banget bisa bantu kamu. Kalau ada hal lain yang ingin ditanyakan, jangan ragu panggil Yuki ya!"
      ]
    },
    {
