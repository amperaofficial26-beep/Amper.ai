...
# Fungsi untuk mengubah background gambar lokal agar bisa dibaca CSS
def set_background(image_file):
  try:
    ...
    css = f"""
        <style>
        .stApp {{
            background-image: linear-gradient( rgba(0, 0, 0, 0.85), rgba(0, 0, 0, 0.85) ), url("data:image/jpeg;base64,{encoded}");
